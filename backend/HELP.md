...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/2.6.10/reference/htmlsingle/#data.sql.jdbc)
* [JDBC API](https://docs.spring.io/spring-boot/docs/2.6.10/reference/htmlsingle/#data.sql)
